                  ...
                  children: [
                    ...
                    Obx(
                      () => Column(
                        ...
                        children: [
                          Text(
                            'Data Source: ${controller.isWebSocketConnected ? 'Live' : 'Simulated'}',
                            style: theme.textTheme.bodySmall?.copyWith(
                              color: controller.isWebSocketConnected
                                  ? Colors.green
                                  : Colors.orange,
                      ...
                      () => GridView.count(
                        ...
                        children: [
                          ...
                          SensorCard(
                            ...
                            status: controller.isHumidityOk ? 'OK' : 'Warning',
                          ),
                          SensorCard(
                            title: 'Light Level',
                        ...
                        () => Row(
                          children: [
                            ...
                            Expanded(
                              child: SensorCard(
                                title: 'EC Level',
                                value: controller.ecLevel.value.toStringAsFixed(
                                  1,
                                ),
                                unit: 'mS/cm',
                                icon: Icons.electric_bolt,
                                iconColor: Colors.orange,
                                status: controller.isEcOk ? 'OK' : 'Warning',
                              ),
                            ),
                          ],
                        ),
                ...
                Obx(
                  () => Column(
                    children: [
                      ...
                      SystemStatusCard(
                        title: 'Grow Lights',
                        status: controller.growLightStatus.value ? 'ON' : 'OFF',
                        icon: Icons.lightbulb,
                        iconColor: Colors.amber,
                      ...
                      return Obx(
                        () => GridView.count(
                          ...
                          children: [
                            ...
                            _buildThresholdItem(
                              'EC',
                              '${controller.ecMin.toStringAsFixed(1)} - ${controller.ecMax.toStringAsFixed(1)} mS/cm',
                              Icons.electric_bolt,
                              Colors.orange,
                            ),
                          ],
                  ...
                  () => Column(
                    children: [
                      MiniGraph(
                        ...
                        title: 'Temperature',
                        value: controller.temperature.value.toStringAsFixed(1),
                        unit: '°C',
                      ),
                      SizedBox(height: 8),
                      MiniGraph(
